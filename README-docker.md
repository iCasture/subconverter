...
This is a minimized image to run https://github.com/icasture/subconverter.

For running this docker, simply use the following commands:
```bash
# run the container detached, forward internal port 25500 to host port 25500
docker run -d --restart=always -p 25500:25500 icasture/subconverter:latest
...
services:
  subconverter:
    image: icasture/subconverter:latest
...
FROM icasture/subconverter:latest
